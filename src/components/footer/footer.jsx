            ...
            <Container>
                ...
                <h3 className='mb-5'>The Eagles</h3>
                    <Col md={4} xs={12} className="mb-3">
                        ...
                        <p>#41/36, Mothikhana Buildings, old Santhepet Road, Mysore - 570024</p>
                    </Col>
                    <Col md={4} xs={12} className="mb-3">                        
                        <h5>Bangalore</h5>
                        <p>+91 9845034692</p>
                ...
                <p className='text-center mt-5 foorights'><img src='/logo.png' className='foologo'/>&nbsp; &copy; {new Date().getFullYear()} The Eagles. All Rights Reserved.</p>
